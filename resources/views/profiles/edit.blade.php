<x-app>
    <form method="POST" action="{{ $user->path() }}" enctype="multipart/form-data">
        ...
        <div class="mb-6">
            <label class="black mb-2 uppercase font-bold text-xs text-gray-700" for="avatar">
                Avatar
            </label>
        ...
        <div class="mb-6">
            <label class="black mb-2 uppercase font-bold text-xs text-gray-700" for="password_confirmation">
